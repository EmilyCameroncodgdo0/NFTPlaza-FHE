...
export const encryptBidAmount = async (
  ...
  console.log('[FHE] Encrypting bid:', bidAmountWei.toString());
  ...
  input.add64(Number(bidAmountWei));
  ...
  return {
    encryptedBid: toHex(handles[0]) as `0x${string}`,
